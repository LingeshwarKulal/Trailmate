        ...
        return (
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="mt-8 flex justify-between">
              ...
              <button
                onClick={() => alert('Trip plan saved successfully!')}
                className="px-6 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors"
              >
                Save Trip Plan
              </button>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Trail Trip Planner</h1>
          <p className="text-gray-600">Create a personalized hiking itinerary and plan your next adventure</p>
        </div>
